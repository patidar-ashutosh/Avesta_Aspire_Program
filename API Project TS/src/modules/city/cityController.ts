import { cityQuery } from "./cityModel";
import { Request, Response, NextFunction } from "express";

// Handle fetching all cities
const getAllCities = async (req : Request, res : Response, next : NextFunction) : Promise<void> => {
    try {
...
const getAnySelectedCity = async (req : Request, res : Response, next : NextFunction) : Promise<void> => {
    try {
...
const addNewCity = async (req : Request, res : Response, next : NextFunction) : Promise<void> => {
    try {
...
const deleteCity = async (req : Request, res : Response, next : NextFunction) : Promise<void> => {
    try{
        const cityName = req.params.cityName;
