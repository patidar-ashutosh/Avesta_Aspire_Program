import { customerQuery } from "./customerModel";
import { Request, Response, NextFunction } from "express";

// Handle fetching movies show by city
const getMovieByCityName = async (req : Request, res : Response, next : NextFunction) : Promise<void> => {
    try {
...
const getMovieByCinemaHall = async (req : Request, res : Response, next : NextFunction) : Promise<void> => {
    try {
...
const getMovieByName = async (req : Request, res : Response, next : NextFunction) : Promise<void> => {
    try {
...
const getShowSeatingPlan = async (req : Request, res : Response, next : NextFunction) : Promise<void> => {
    try {
        ...
        if (
            ...
            typeof cinemaName === 'string' &&
            typeof cinemaHallName === 'string' &&
...
const getTopTenActorWithMaxMovies = async (req : Request, res : Response, next : NextFunction) : Promise<void> => {
    try {
...
const getMovieByYear = async (req : Request, res : Response, next : NextFunction) : Promise<void> => {
    try {
