...
const ceoQuery = {
    ...
    getTotalNumberOfBookingByCinemaQuery : async () => {
    ...
    getCustomerBySelectedMovieAndCinemaQuery : async (cinemaName, movieName) => {
